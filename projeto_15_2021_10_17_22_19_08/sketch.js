...
function setup() {
  ...
  faca.setCollider("rectangle",0,-15,80,100);
  //faca.debug= true;
...
function draw() {
  ...
  if(placar>0 && placar%4 === 0){
      grupoFruta.setVelocityXEach(8+2*placar/4);
    }
  
  if(placar>0 && placar%10 === 0){
    grupoMonstro.setVelocityX=(8+2*placar/4);
  }
